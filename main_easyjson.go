...
func easyjson89aae3efDecodeGithubComNsherron90JuansFilppaApp(in *jlexer.Lexer, out *Flippa) {
...
func easyjson89aae3efEncodeGithubComNsherron90JuansFilppaApp(out *jwriter.Writer, in Flippa) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Flippa) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson89aae3efEncodeGithubComNsherron90JuansFilppaApp(&w, v)
...
func (v *Flippa) UnmarshalJSON(data []byte) error {
	...
	easyjson89aae3efDecodeGithubComNsherron90JuansFilppaApp(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Flippa) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson89aae3efDecodeGithubComNsherron90JuansFilppaApp(l, v)
}
...
func easyjson89aae3efDecodeGithubComNsherron90JuansFilppaApp1(in *jlexer.Lexer, out *Doc) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
				...
				if out.Data == nil {
					if !in.IsDelim(']') {
						out.Data = make([]struct {
							Type                  string        `json:"type"`
							ID                    string        `json:"id"`
							AppDownloadsPerMonth  interface{}   `json:"appDownloadsPerMonth"`
							AverageProfit         interface{}   `json:"averageProfit"`
							AverageRevenue        interface{}   `json:"averageRevenue"`
							BidCount              int           `json:"bidCount"`
							BusinessModel         string        `json:"businessModel"`
							BuyItNowPrice         interface{}   `json:"buyItNowPrice"`
							Confidential          bool          `json:"confidential"`
							CurrentPrice          int           `json:"currentPrice"`
							EndsAt                time.Time     `json:"endsAt"`
							EstablishedAt         time.Time     `json:"establishedAt"`
							ExternalURL           string        `json:"externalUrl"`
							HasVerifiedRevenue    bool          `json:"hasVerifiedRevenue"`
							HasVerifiedTraffic    bool          `json:"hasVerifiedTraffic"`
							HTMLURL               string        `json:"htmlUrl"`
							Hostname              string        `json:"hostname"`
							Industry              string        `json:"industry"`
							PageViewsPerMonth     interface{}   `json:"pageViewsPerMonth"`
							PostAuctionNegotiable bool          `json:"postAuctionNegotiable"`
							ProfitPerMonth        interface{}   `json:"profitPerMonth"`
							PropertyName          string        `json:"propertyName"`
							PropertyType          string        `json:"propertyType"`
							ReserveMet            bool          `json:"reserveMet"`
							RevenuePerMonth       interface{}   `json:"revenuePerMonth"`
							RevenueSources        []interface{} `json:"revenueSources"`
							SaleMethod            string        `json:"saleMethod"`
							StartsAt              time.Time     `json:"startsAt"`
							Status                string        `json:"status"`
							Summary               string        `json:"summary"`
							Title                 string        `json:"title"`
							UniquesPerMonth       interface{}   `json:"uniquesPerMonth"`
							Watching              bool          `json:"watching"`
						}, 0, 1)
					} else {
						out.Data = []struct {
...
func easyjson89aae3efEncodeGithubComNsherron90JuansFilppaApp1(out *jwriter.Writer, in Doc) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.Data == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v8, v9 := range in.Data {
				...
				easyjson89aae3efEncode1(out, v9)
			}
			out.RawByte(']')
		}
	}
...
func (v Doc) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson89aae3efEncodeGithubComNsherron90JuansFilppaApp1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Doc) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson89aae3efDecodeGithubComNsherron90JuansFilppaApp1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Doc) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson89aae3efDecodeGithubComNsherron90JuansFilppaApp1(l, v)
}
func easyjson89aae3efDecode1(in *jlexer.Lexer, out *struct {
	Type                  string        `json:"type"`
	ID                    string        `json:"id"`
	AppDownloadsPerMonth  interface{}   `json:"appDownloadsPerMonth"`
	AverageProfit         interface{}   `json:"averageProfit"`
	...
	for !in.IsDelim('}') {
		...
		case "externalUrl":
			out.ExternalURL = string(in.String())
		case "hasVerifiedRevenue":
			out.HasVerifiedRevenue = bool(in.Bool())
		case "hasVerifiedTraffic":
			out.HasVerifiedTraffic = bool(in.Bool())
		case "htmlUrl":
			out.HTMLURL = string(in.String())
		case "hostname":
		...
		case "revenueSources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.RevenueSources = append(out.RevenueSources, v10)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson89aae3efEncode1(out *jwriter.Writer, in struct {
	Type                  string        `json:"type"`
	ID                    string        `json:"id"`
	AppDownloadsPerMonth  interface{}   `json:"appDownloadsPerMonth"`
	AverageProfit         interface{}   `json:"averageProfit"`
	...
	{
		const prefix string = ",\"appDownloadsPerMonth\":"
		out.RawString(prefix)
		if m, ok := in.AppDownloadsPerMonth.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.AppDownloadsPerMonth.(json.Marshaler); ok {
	...
	{
		const prefix string = ",\"averageProfit\":"
		out.RawString(prefix)
		if m, ok := in.AverageProfit.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.AverageProfit.(json.Marshaler); ok {
	...
	{
		const prefix string = ",\"averageRevenue\":"
		out.RawString(prefix)
		if m, ok := in.AverageRevenue.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.AverageRevenue.(json.Marshaler); ok {
	...
	{
		const prefix string = ",\"bidCount\":"
		out.RawString(prefix)
		out.Int(int(in.BidCount))
	}
	{
		const prefix string = ",\"businessModel\":"
		out.RawString(prefix)
		out.String(string(in.BusinessModel))
	}
	{
		const prefix string = ",\"buyItNowPrice\":"
		out.RawString(prefix)
		if m, ok := in.BuyItNowPrice.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.BuyItNowPrice.(json.Marshaler); ok {
	...
	{
		const prefix string = ",\"establishedAt\":"
		out.RawString(prefix)
		out.Raw((in.EstablishedAt).MarshalJSON())
	}
	{
	...
	{
		const prefix string = ",\"hasVerifiedRevenue\":"
		out.RawString(prefix)
		out.Bool(bool(in.HasVerifiedRevenue))
	}
	{
		const prefix string = ",\"hasVerifiedTraffic\":"
		out.RawString(prefix)
		out.Bool(bool(in.HasVerifiedTraffic))
	}
	{
		const prefix string = ",\"htmlUrl\":"
		out.RawString(prefix)
		out.String(string(in.HTMLURL))
	}
	{
	...
	{
		const prefix string = ",\"pageViewsPerMonth\":"
		out.RawString(prefix)
		if m, ok := in.PageViewsPerMonth.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.PageViewsPerMonth.(json.Marshaler); ok {
	...
	{
		const prefix string = ",\"postAuctionNegotiable\":"
		out.RawString(prefix)
		out.Bool(bool(in.PostAuctionNegotiable))
	}
	{
		const prefix string = ",\"profitPerMonth\":"
		out.RawString(prefix)
		if m, ok := in.ProfitPerMonth.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.ProfitPerMonth.(json.Marshaler); ok {
	...
	{
		const prefix string = ",\"reserveMet\":"
		out.RawString(prefix)
		out.Bool(bool(in.ReserveMet))
	}
	{
		const prefix string = ",\"revenuePerMonth\":"
		out.RawString(prefix)
		if m, ok := in.RevenuePerMonth.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.RevenuePerMonth.(json.Marshaler); ok {
	...
	{
		const prefix string = ",\"revenueSources\":"
		out.RawString(prefix)
		if in.RevenueSources == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			out.RawString("null")
		} else {
			out.RawByte('[')
			for v11, v12 := range in.RevenueSources {
				if v11 > 0 {
					out.RawByte(',')
				}
	...
	{
		const prefix string = ",\"saleMethod\":"
		out.RawString(prefix)
		out.String(string(in.SaleMethod))
	}
	{
	...
	{
		const prefix string = ",\"uniquesPerMonth\":"
		out.RawString(prefix)
		if m, ok := in.UniquesPerMonth.(easyjson.Marshaler); ok {
			m.MarshalEasyJSON(out)
		} else if m, ok := in.UniquesPerMonth.(json.Marshaler); ok {
